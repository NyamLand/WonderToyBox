...
//-------------------------------------------------------------------------
	...
	void	Effect::Initialize()
	{
		...
		circle_pic[0] = new iex2DObj("DATA/Effect/PL1-3.png");
		circle_pic[1] = new iex2DObj("DATA/Effect/PL2-3.png");
		circle_pic[2] = new iex2DObj("DATA/Effect/PL3-3.png");
		circle_pic[3] = new iex2DObj("DATA/Effect/PL4-3.png");
