...
void	PirateBullet01::Update(void)
{
...
void	PirateBullet01::Move(void)
{
	move.y += GRAVITY;
}

//void	PirateBullet01::Explode(void)
//{
//	radius += 1.0f;
//	move = Vector3(0, 0, 0);
...
////	プレイヤーとのあたりチェック
//bool	PirateBullet01::PlayerCollisionCheck(void)
//{
//	for (int i = 0; i < 4; i++)
//	{
