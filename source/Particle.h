...
public:
	...
	void	Particle::Arrow_UP(const Vector3& pos, const int& time = 1, const float& scale = 1.0f, const int move = 100);				//	矢印UP
	void	Particle::Arrow_DOWN(const Vector3& pos, const int& time = 1, const float& scale = 1.0f, const int move = 100);				//	矢印DOWN
