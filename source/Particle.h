...
public:
	...
	void	Dust( const Vector3& pos, const Vector3& back, const Vector3& side, const float& scale = 1.0f, const int& time = 1 );											//	砂埃
	void	Bom( const Vector3& pos, const float& move, const float& scale = 1.0f, const int& time = 6 );																	//	爆発
	void	Flower( const Vector3& pos, float scale, const Vector3& color );																								//	花
	void	FlowerDisseminate( const Vector3& pos, float scale, float speed, const Vector3& color );																		//	花ばらまき
	void	Bomb( const Vector3& pos, float scale, const Vector3& color );																									//	大砲発射後
	...
	void	FireBall( const Vector3& pos, float scale, const Vector3& color );																								//	魔女ファイアー
	void	BombFireBall( const Vector3& pos, float scale, const Vector3& color );
